...
class LogisticRegressionModel(torch.nn.Module):
    def __init__(self, lr, epoch_num, input_dim):
        ...
        self.lr = lr
        self.epoch_num = epoch_num
        self.criterion = torch.nn.BCELoss(size_average=False)  # Use BCEWithLogitsLoss for stability
...
if __name__ == '__main__':
    ...
    y_data = torch.randint(0, 2, (100, 1), dtype=torch.float32)  # Binary classification, 0 or 1
